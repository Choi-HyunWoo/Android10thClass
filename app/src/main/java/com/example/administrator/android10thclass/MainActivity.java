...
public class MainActivity extends AppCompatActivity {
     ...
     *
     * - Java에서는 Graphics 라는 클래스를 사용하지만 바뀜!
     * - onDraw() 메소드의 Canvas라는 객체를 이용하여 그리자
     ...
     *** 더블버퍼링의 이점
     ...
     45개의 점을 Video Memory에 찍는 경우 45번의 버스가 CPU >> Video memory로 호출
     버스 안에는 한번에 많은 양을 담고 한번에 보내는것이 이득
     Memory에 그린 후 Bus로 한번에 보내자.!
